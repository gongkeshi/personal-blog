...
| Ice Cultivator Skills | Q, E, R, F, and Space |
...
The current version focuses on the stable playable core. The embedded AI assistant bonus is not implemented yet.

Planned next steps:

1. Add an in-game "器灵助手" panel.
2. Let the assistant react to score, HP, selected character, and skill cooldown.
3. Add optional DeepSeek API support for more natural advice.
4. Add screenshots or a short demo video for the final presentation.
5. Continue balancing enemy waves and skill cooldowns.
...
| Bonus: Embedded AI Agent | Planned for the next iteration |
